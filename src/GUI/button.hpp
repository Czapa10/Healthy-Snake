...
public:
    ...
    Button(Game::GameDataRef data, const Fonts::ID&, const std::string&, sf::Vector2f pos, sf::IntRect notPointedRect, sf::IntRect pointedRect, unsigned int fontSize = 50, bool isActive = true);
    Button(Game::GameDataRef data, const Fonts::ID&, const std::string&, sf::Vector2f pos, sf::IntRect notPointedRect, sf::IntRect pointedRect, sf::Vector2i clickBoxExpand, unsigned int fontSize = 50, bool isActive = true);
